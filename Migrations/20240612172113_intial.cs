    ...
    public partial class intial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ItemIdCart = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ItemNameCart = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    QuantityCart = table.Column<int>(type: "int", nullable: false),
                    ItemPriceCart = table.Column<decimal>(type: "decimal(18,2)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CartItems", x => x.ItemIdCart);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CatageryId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CatageryName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CatageryImage = table.Column<byte[]>(type: "varbinary(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Catagerys", x => x.CatageryId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Brands_Catagerys_CatageryId",
                        column: x => x.CatageryId,
                        principalTable: "Catagerys",
                        principalColumn: "CatageryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrderQuantity = table.Column<int>(type: "int", maxLength: 100, nullable: false),
